...
void Module_dasBGFX::initFunctions_8() {
	...
	addExtern<unsigned long long (*)(bgfx_texture_handle_s,unsigned long long),bgfx_override_internal_texture_ptr>(*this,lib,"bgfx_override_internal_texture_ptr",SideEffects::worstDefault,"bgfx_override_internal_texture_ptr")
		->args({"_handle","_ptr"});
	addExtern<unsigned long long (*)(bgfx_texture_handle_s,unsigned short,unsigned short,unsigned char,bgfx_texture_format_t,unsigned long long),bgfx_override_internal_texture>(*this,lib,"bgfx_override_internal_texture",SideEffects::worstDefault,"bgfx_override_internal_texture")
