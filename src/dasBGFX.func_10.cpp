...
void Module_dasBGFX::initFunctions_10() {
	addExtern<void (*)(unsigned char,bgfx_vertex_buffer_handle_s,bgfx_access_t),bgfx_set_compute_vertex_buffer>(*this,lib,"bgfx_set_compute_vertex_buffer",SideEffects::worstDefault,"bgfx_set_compute_vertex_buffer")
		->args({"_stage","_handle","_access"});
	addExtern<void (*)(unsigned char,bgfx_dynamic_index_buffer_handle_s,bgfx_access_t),bgfx_set_compute_dynamic_index_buffer>(*this,lib,"bgfx_set_compute_dynamic_index_buffer",SideEffects::worstDefault,"bgfx_set_compute_dynamic_index_buffer")
		->args({"_stage","_handle","_access"});
	addExtern<void (*)(unsigned char,bgfx_dynamic_vertex_buffer_handle_s,bgfx_access_t),bgfx_set_compute_dynamic_vertex_buffer>(*this,lib,"bgfx_set_compute_dynamic_vertex_buffer",SideEffects::worstDefault,"bgfx_set_compute_dynamic_vertex_buffer")
		->args({"_stage","_handle","_access"});
	addExtern<void (*)(unsigned char,bgfx_indirect_buffer_handle_s,bgfx_access_t),bgfx_set_compute_indirect_buffer>(*this,lib,"bgfx_set_compute_indirect_buffer",SideEffects::worstDefault,"bgfx_set_compute_indirect_buffer")
		->args({"_stage","_handle","_access"});
	addExtern<void (*)(unsigned char,bgfx_texture_handle_s,unsigned char,bgfx_access_t,bgfx_texture_format_t),bgfx_set_image>(*this,lib,"bgfx_set_image",SideEffects::worstDefault,"bgfx_set_image")
