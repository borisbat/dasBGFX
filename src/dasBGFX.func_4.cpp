...
void Module_dasBGFX::initFunctions_4() {
	addExtern< void (*)(bgfx_program_handle_s) , bgfx_destroy_program >(*this,lib,"bgfx_destroy_program",SideEffects::worstDefault,"bgfx_destroy_program")
		->args({"_handle"});
	addExtern< bool (*)(unsigned short,bool,unsigned short,bgfx_texture_format,unsigned long long) , bgfx_is_texture_valid >(*this,lib,"bgfx_is_texture_valid",SideEffects::worstDefault,"bgfx_is_texture_valid")
	...
	addExtern< bgfx_texture_handle_s (*)(unsigned short,unsigned short,bool,unsigned short,bgfx_texture_format,unsigned long long,const bgfx_memory_s *) , bgfx_create_texture_2d ,SimNode_ExtFuncCallAndCopyOrMove>(*this,lib,"bgfx_create_texture_2d",SideEffects::worstDefault,"bgfx_create_texture_2d")
		->args({"_width","_height","_hasMips","_numLayers","_format","_flags","_mem"});
	addExtern< bgfx_texture_handle_s (*)(bgfx_backbuffer_ratio,bool,unsigned short,bgfx_texture_format,unsigned long long) , bgfx_create_texture_2d_scaled ,SimNode_ExtFuncCallAndCopyOrMove>(*this,lib,"bgfx_create_texture_2d_scaled",SideEffects::worstDefault,"bgfx_create_texture_2d_scaled")
		->args({"_ratio","_hasMips","_numLayers","_format","_flags"});
	addExtern< bgfx_texture_handle_s (*)(unsigned short,unsigned short,unsigned short,bool,bgfx_texture_format,unsigned long long,const bgfx_memory_s *) , bgfx_create_texture_3d ,SimNode_ExtFuncCallAndCopyOrMove>(*this,lib,"bgfx_create_texture_3d",SideEffects::worstDefault,"bgfx_create_texture_3d")
		->args({"_width","_height","_depth","_hasMips","_format","_flags","_mem"});
	addExtern< bgfx_texture_handle_s (*)(unsigned short,bool,unsigned short,bgfx_texture_format,unsigned long long,const bgfx_memory_s *) , bgfx_create_texture_cube ,SimNode_ExtFuncCallAndCopyOrMove>(*this,lib,"bgfx_create_texture_cube",SideEffects::worstDefault,"bgfx_create_texture_cube")
	...
	addExtern< void (*)(bgfx_texture_handle_s) , bgfx_destroy_texture >(*this,lib,"bgfx_destroy_texture",SideEffects::worstDefault,"bgfx_destroy_texture")
		->args({"_handle"});
	addExtern< bgfx_frame_buffer_handle_s (*)(unsigned short,unsigned short,bgfx_texture_format,unsigned long long) , bgfx_create_frame_buffer ,SimNode_ExtFuncCallAndCopyOrMove>(*this,lib,"bgfx_create_frame_buffer",SideEffects::worstDefault,"bgfx_create_frame_buffer")
		->args({"_width","_height","_format","_textureFlags"});
	addExtern< bgfx_frame_buffer_handle_s (*)(bgfx_backbuffer_ratio,bgfx_texture_format,unsigned long long) , bgfx_create_frame_buffer_scaled ,SimNode_ExtFuncCallAndCopyOrMove>(*this,lib,"bgfx_create_frame_buffer_scaled",SideEffects::worstDefault,"bgfx_create_frame_buffer_scaled")
