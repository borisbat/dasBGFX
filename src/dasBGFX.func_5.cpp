...
void Module_dasBGFX::initFunctions_5() {
	addExtern<bgfx_frame_buffer_handle_s (*)(void *,unsigned short,unsigned short,bgfx_texture_format_t,bgfx_texture_format_t),bgfx_create_frame_buffer_from_nwh,SimNode_ExtFuncCallAndCopyOrMove>(*this,lib,"bgfx_create_frame_buffer_from_nwh",SideEffects::worstDefault,"bgfx_create_frame_buffer_from_nwh")
	...
	addExtern<void (*)(bgfx_frame_buffer_handle_s),bgfx_destroy_frame_buffer>(*this,lib,"bgfx_destroy_frame_buffer",SideEffects::worstDefault,"bgfx_destroy_frame_buffer")
		->args({"_handle"});
	addExtern<bgfx_uniform_handle_s (*)(const char *,bgfx_uniform_type_t,unsigned short),bgfx_create_uniform,SimNode_ExtFuncCallAndCopyOrMove>(*this,lib,"bgfx_create_uniform",SideEffects::worstDefault,"bgfx_create_uniform")
	...
	addExtern<bgfx_occlusion_query_result_t (*)(bgfx_occlusion_query_handle_s,int *),bgfx_get_result>(*this,lib,"bgfx_get_result",SideEffects::worstDefault,"bgfx_get_result")
	...
	addExtern<void (*)(unsigned short,unsigned short,unsigned short,bgfx_backbuffer_ratio_t),bgfx_set_view_rect_ratio>(*this,lib,"bgfx_set_view_rect_ratio",SideEffects::worstDefault,"bgfx_set_view_rect_ratio")
	...
	addExtern<void (*)(unsigned short,bgfx_view_mode_t),bgfx_set_view_mode>(*this,lib,"bgfx_set_view_mode",SideEffects::worstDefault,"bgfx_set_view_mode")
		->args({"_id","_mode"});
