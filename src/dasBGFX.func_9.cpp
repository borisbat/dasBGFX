...
void Module_dasBGFX::initFunctions_9() {
	...
	addExtern<void (*)(unsigned char,bgfx_index_buffer_handle_s,bgfx_access_t),bgfx_set_compute_index_buffer>(*this,lib,"bgfx_set_compute_index_buffer",SideEffects::worstDefault,"bgfx_set_compute_index_buffer")
