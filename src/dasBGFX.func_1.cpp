...
void Module_dasBGFX::initFunctions_1() {
	addExtern<void (*)(bgfx_attachment_s *,bgfx_texture_handle_s,bgfx_access_t,unsigned short,unsigned short,unsigned short,unsigned char),bgfx_attachment_init>(*this,lib,"bgfx_attachment_init",SideEffects::worstDefault,"bgfx_attachment_init")
		->args({"_this","_handle","_access","_layer","_numLayers","_mip","_resolve"});
	addExtern<bgfx_vertex_layout_s * (*)(bgfx_vertex_layout_s *,bgfx_renderer_type_t),bgfx_vertex_layout_begin>(*this,lib,"bgfx_vertex_layout_begin",SideEffects::worstDefault,"bgfx_vertex_layout_begin")
		->args({"_this","_rendererType"});
	addExtern<bgfx_vertex_layout_s * (*)(bgfx_vertex_layout_s *,bgfx_attrib_t,unsigned char,bgfx_attrib_type_t,bool,bool),bgfx_vertex_layout_add>(*this,lib,"bgfx_vertex_layout_add",SideEffects::worstDefault,"bgfx_vertex_layout_add")
		->args({"_this","_attrib","_num","_type","_normalized","_asInt"});
	addExtern<void (*)(const bgfx_vertex_layout_s *,bgfx_attrib_t,unsigned char *,bgfx_attrib_type *,bool *,bool *),bgfx_vertex_layout_decode>(*this,lib,"bgfx_vertex_layout_decode",SideEffects::worstDefault,"bgfx_vertex_layout_decode")
		->args({"_this","_attrib","_num","_type","_normalized","_asInt"});
	addExtern<bool (*)(const bgfx_vertex_layout_s *,bgfx_attrib_t),bgfx_vertex_layout_has>(*this,lib,"bgfx_vertex_layout_has",SideEffects::worstDefault,"bgfx_vertex_layout_has")
		->args({"_this","_attrib"});
	...
	addExtern<void (*)(bgfx_vertex_layout_s *),bgfx_vertex_layout_end>(*this,lib,"bgfx_vertex_layout_end",SideEffects::worstDefault,"bgfx_vertex_layout_end")
		->args({"_this"});
	addExtern<void (*)(float const[4],bool,bgfx_attrib_t,const bgfx_vertex_layout_s *,void *,unsigned int),bgfx_vertex_pack>(*this,lib,"bgfx_vertex_pack",SideEffects::worstDefault,"bgfx_vertex_pack")
		->args({"_input","_inputNormalized","_attr","_layout","_data","_index"});
	addExtern<void (*)(float [4],bgfx_attrib_t,const bgfx_vertex_layout_s *,const void *,unsigned int),bgfx_vertex_unpack>(*this,lib,"bgfx_vertex_unpack",SideEffects::worstDefault,"bgfx_vertex_unpack")
	...
	addExtern<void (*)(bgfx_topology_sort_t,void *,unsigned int,float const[3],float const[3],const void *,unsigned int,const void *,unsigned int,bool),bgfx_topology_sort_tri_list>(*this,lib,"bgfx_topology_sort_tri_list",SideEffects::worstDefault,"bgfx_topology_sort_tri_list")
	...
	addExtern<unsigned char (*)(unsigned char,bgfx_renderer_type *),bgfx_get_supported_renderers>(*this,lib,"bgfx_get_supported_renderers",SideEffects::worstDefault,"bgfx_get_supported_renderers")
		->args({"_max","_enum"});
	addExtern<const char * (*)(bgfx_renderer_type_t),bgfx_get_renderer_name>(*this,lib,"bgfx_get_renderer_name",SideEffects::worstDefault,"bgfx_get_renderer_name")
		->args({"_type"});
	...
	addExtern<void (*)(unsigned int,unsigned int,unsigned int,bgfx_texture_format_t),bgfx_reset>(*this,lib,"bgfx_reset",SideEffects::worstDefault,"bgfx_reset")
